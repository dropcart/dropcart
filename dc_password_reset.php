...
$strEmail = (isset($_POST['email_forgot'])) ? strtolower($_POST['email_forgot']) : null;
if (empty($strEmail)) {
    $strEmail = (isset($_GET['email'])) ? $_GET['email'] : null;
}
$strTokenGet = (isset($_GET['token'])) ? $_GET['token'] : null;
