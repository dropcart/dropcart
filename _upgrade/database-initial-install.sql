...
(4, 'discountCodeMail', 'info@dropcart.nl', 'Dropcart', '', 'bcc@dropcart.nl'),
(5, 'password_reset', 'info@dropcart.nl', 'Dropcart', '', '');
...
(4, 'Mail a friend met kortingscode', 'Wordt verzonden indien de klant een resterend tegoed over heeft en dit wilt schenken aan iemand.', '[CUSTOMER_NAME] heeft een cadeaubon voor [FRIEND_NAME]', 'Beste [FRIEND_NAME],\r\n\r\nU heeft van [CUSTOMER_NAME] een cadeaubon ontvangen t.v.w. **â‚¬ [DISCOUNT_AMOUNT]** om te besteden op [SITE_NAME].\r\n\r\nOm uw cadeaubon te gebruiken kunt de volgende vouchercode bij het afrekenen invullen:\r\n\r\n**[DISCOUNT_CODE]**\r\n\r\nLet op! Dit tegoed is 3 maanden geldig, hierna vervalt het tegoed.\r\n\r\nMet vriendelijke groet,\r\n\r\n[SITE_NAME] namens [CUSTOMER_NAME]'),
(5, 'Wachtwoord vergeten', 'wachtwoord vergeten', 'wachtwoord vergeten', 'Beste [CUSTOMER_NAME],\r\n\r\nKlik op onderstaande link om direct in te loggen op [SITE_NAME] om vervolgens uw wachtwoord te resetten.\r\n\r\n[LOGIN_LINK]\r\n\r\nMet vriendelijke groet,\r\n\r\n[SITE_NAME]');
